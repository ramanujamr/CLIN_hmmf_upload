...
tab_indole_qual = tabPanel("Indole - Qual", fluid=TRUE,
                        ...
                        fluidRow(column(12,
                                        ...
                                        h5("removed_qcs_normalized_results_yyyymmdd_Indole_XXXX###_yyyymmdd"),
                                        h5("Example: removed_qcs_normalized_results_20201214_Indole_CLIN012_20211206")
                        )
                        ),
                        ...
                        fluidRow(column(4, 
                                        DT::dataTableOutput("table_indole_qual")
                        )
                        ), 
